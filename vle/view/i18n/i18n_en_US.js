View.prototype.i18n.en_US = 
{
	...
	"top_toolbar_ideas_button_text":{
		"value":"Ideas",
		"description":"Text on the Idea Manager button on Top Toolbar"
	},
	"top_toolbar_addidea_button_text":{
		"value":"Add Idea",
		"description":"Text on the Add Idea button on Top Toolbar"
	},
	"top_toolbar_mywork_button_text":{
		"value":"Design Journal",
		"description":"Text on the Design Journal button on Top Toolbar"
	},
	"top_toolbar_flagged_button_text":{
		"value":"Flagged",
		"description":"Text on the Flagged button on Top Toolbar"
	},
	"top_toolbar_journal_button_text":{
		"value":"Design Portfolio",
		"description":"Text on the Design Portfolio button on Top Toolbar"
	},
	"top_toolbar_fullscreen_button_text":{
		"value":"Full Screen",
		"description":"Text on the Full Screen button on Top Toolbar"
	},
	"top_toolbar_signout_button_text":{
		"value":"Sign Out",
		"description":"Text on the Log out button on Top Toolbar"
	},
	"top_toolbar_gohome_button_text":{
		"value":"Home",
		"description":"Text on the Home button on Top Toolbar"
	},		
	"top_toolbar_hint_button_text":{
		"value":"Hints",
		"description":"Text that shows up next to the Hint button in the top tool bar"
	},
	"hint_title":{
		"value":"Step Hint",
		"description":"Title that shows up in the hint window"
	},
	"hint_hint":{
		"value":"Hint",
		"description":"will be shown as Hint (1 of 2)"
	},
	"hint_next":{
		"value":"Next",
	...
	"navigation_expand_all":{
		"value":"Expand All",
		"description":"Text on a button to expand all navigation items"
	},
	"navigation_collapse_all":{
		"value":"Collapse All",
		"description":"Text on a button to collapse all navigation items"
	},	
	...
	"idea_basket_add_an_idea":{
		"value":"Add an Idea",
		"description":"The text 'Add an Idea' in the Idea Manager"
	},
	"idea_basket_retrieval_error":{
		"value":"Error: Could not open Idea Basket, refresh the VLE to try to load it again",
	...
	"grading_button_view_student_uploaded_files":{
		"value":"View Student Uploaded Files",
	...
	"grading_button_check_for_new_student_work":{
		"value":"Check for New Student Work",
	...
	"grading_grade_by_step_header":{
		"value":"GRADE BY STEP (select a step below)",
	...
	"grading_grade_by_step_percent_completed_step":{
		"value":"% of Students Who Have Completed This Step",
	...
	"grading_grade_by_team_header":{
		"value":"GRADE BY TEAM (select a team below)",
	...
	"grading_hide_show_question":{
		...
		"description":"'hide/show question' link that toggles the question's visibility in the gradingtool"
	},
	"grading_previous_step":{
		"value":"Previous Step",
		"description":"'Previous Step' button in the gradingtool that will show the previous step in the project"
	},
	...
	"grading_change_step":{
		"value":"Change Step",
		"description":"'Change Step' button in the gradingtool that will show the select step page"
	},
	"grading_next_step":{
		"value":"Next Step",
		"description":"'Next Step' button in the gradingtool that will show the next step in the project"
	},	
	"grading_next_step_not_exist":{
		"value":"Next Step does not exist: this is the last gradable step",
		"description":"Text to show when next step does not exist because this is the last gradable step in teh project"
	},	
	"period":{
		"value":"Period",
		"description":"Period"
	...
	"flag":{
		"value":"Flag",
		"description":"Flag, for flagging student's work using the flaggingtool"
	},
	"timestamp":{
		"value":"Timestamp",
	...
	"last_annotation":{
		"value":"Last Annotation",
		"description":"the text 'last annotation'"
	},		
	"grading_open_premade_comments":{
		"value":"Open Premade Comments",
		"description":"the text 'open premade comments' that will open the premadecomments window when clicked"
	},		
	"not_available":{
		"value":"not available",
	...
	"grading_no_work_warning":{
		"value":"Student has not submitted work for this step, you will not be able to score, comment, or flag this item",
	...
	"grading_show_smart_filtered_items_only":{
		"value":"Show Smart-Filtered Items Only",
	...
	"grading_enlarge_student_work_text":{
		"value":"Enlarge Student Work Text",
