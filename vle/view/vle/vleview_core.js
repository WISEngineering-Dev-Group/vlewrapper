...
View.prototype.displayGlobalTools = function() {	
	...
	var myWorkToolbarHtml = "<li id='myWorkTD'><a class=\"\" onclick='eventManager.fire(\"showAllWork\")' title=\"Open Design Journal\"><img src=\"images/reviewAllWork.png\" alt=\"Open Design Journal\" border=\"0\" />"+this.i18n.getString("top_toolbar_mywork_button_text",this.config.getConfigParam("locale"))+"</a></li>";
...
//	var journalToolbarHtml = "<li id='journalTD' style=\"display:none\"><a class=\"\" onclick='eventManager.fire(\"showJournal\")' title=\"Show Student Journal\"><img src=\"images/Journal28x28.png\" alt=\"Show My Journal\" border=\"0\" />&nbsp;"+this.i18n.getString("top_toolbar_journal_button_text",this.config.getConfigParam("locale"))+"</a></li>";
	var journalToolbarHtml = "<li id='journalTD'><a class=\"\" onclick='eventManager.fire(\"showJournal\")' title=\"Open Design Portfolio\"><img src=\"images/Journal28x28.png\" alt=\"Open Design Portfolio\" border=\"0\" />&nbsp;"+this.i18n.getString("top_toolbar_journal_button_text",this.config.getConfigParam("locale"))+"</a></li>";
