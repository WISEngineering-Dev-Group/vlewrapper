/**
 * Sets the DesignWallNode type as an object of this view
 */
View.prototype.DesignWallNode = {};
 ...
 */
View.prototype.DesignWallNode.commonComponents = [];
 ...
 */
View.prototype.DesignWallNode.generatePage = function(view){
	this.view = view;
	 ...
	 * 
	 * onkeyup will fire the 'designWallUpdatePrompt' event which will
	 * be handled in the designWallEvents.js file
	 * 
	 * when you add new authoring components, you will need to create
	 * new events in the designWallEvents.js file and then
	 * create new functions to handle the event
	 */
	var promptTextArea = createElement(document, 'textarea', {id: 'promptTextArea', rows:'20', cols:'85', onkeyup:"eventManager.fire('designWallUpdatePrompt')"});
 ...
 */
View.prototype.DesignWallNode.getCommonComponents = function() {
 ...
 */
View.prototype.DesignWallNode.updateContent = function(){
 ...
 */
View.prototype.DesignWallNode.populatePrompt = function() {
 ...
 */
View.prototype.DesignWallNode.updatePrompt = function(){
	/* update content */
...
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/designWall/authorview_designWall.js');
};