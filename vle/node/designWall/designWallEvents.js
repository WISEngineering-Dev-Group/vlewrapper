...
View.prototype.designWallDispatcher = function(type,args,obj){
	...
	else if (type == 'designWallDeletePosting') {
		currentNode.deletePosting(args[0]);
	}
	else if (type == 'designWallEditPosting') {
		currentNode.editPosting(args[0]);
	}
	else if (type == 'designWallUpdatePosting') {
		currentNode.updatePosting(args[0]);
	}
	else if (type == 'designWallCancelEditPosting') {
		currentNode.cancelEditPosting(args[0]);
	}
};
...
var events = [
	...
	'designWallDeletePosting',
	'designWallEditPosting',
	'designWallUpdatePosting',
	'designWallCancelEditPosting'
];
