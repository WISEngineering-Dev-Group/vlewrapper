 ...
 */
function DesignWallState(response) {
 ...
 * @return a DesignWallState object
 */
DesignWallState.prototype.parseDataJSONObj = function(stateJSONObj) {
 ...
 */
DesignWallState.prototype.getStudentWork = function() {
...
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/designWall/designWallState.js');
}